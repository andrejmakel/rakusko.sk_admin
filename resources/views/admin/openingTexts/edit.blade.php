...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.openingText.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.opening-texts.update", [$openingText->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="sk">{{ trans('cruds.openingText.fields.sk') }}</label>
                <input class="form-control {{ $errors->has('sk') ? 'is-invalid' : '' }}" type="text" name="sk" id="sk" value="{{ old('sk', $openingText->sk) }}">
                @if($errors->has('sk'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('de') ? 'is-invalid' : '' }}" type="text" name="de" id="de" value="{{ old('de', $openingText->de) }}">
                @if($errors->has('de'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs') ? 'is-invalid' : '' }}" type="text" name="cs" id="cs" value="{{ old('cs', $openingText->cs) }}">
                @if($errors->has('cs'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hu') ? 'is-invalid' : '' }}" type="text" name="hu" id="hu" value="{{ old('hu', $openingText->hu) }}">
                @if($errors->has('hu'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sl') ? 'is-invalid' : '' }}" type="text" name="sl" id="sl" value="{{ old('sl', $openingText->sl) }}">
                @if($errors->has('sl'))
