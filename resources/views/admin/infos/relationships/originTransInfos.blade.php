    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-originTransInfos">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.transInfo.fields.origin') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-originTransInfos:not(.ajaxTable)').DataTable({ buttons: dtButtons })
