...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.holidayName.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.holiday-names.update", [$holidayName->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="title_sk">{{ trans('cruds.holidayName.fields.title_sk') }}</label>
                <input class="form-control {{ $errors->has('title_sk') ? 'is-invalid' : '' }}" type="text" name="title_sk" id="title_sk" value="{{ old('title_sk', $holidayName->title_sk) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_cs') ? 'is-invalid' : '' }}" type="text" name="title_cs" id="title_cs" value="{{ old('title_cs', $holidayName->title_cs) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_de') ? 'is-invalid' : '' }}" type="text" name="title_de" id="title_de" value="{{ old('title_de', $holidayName->title_de) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_hu') ? 'is-invalid' : '' }}" type="text" name="title_hu" id="title_hu" value="{{ old('title_hu', $holidayName->title_hu) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_sl') ? 'is-invalid' : '' }}" type="text" name="title_sl" id="title_sl" value="{{ old('title_sl', $holidayName->title_sl) }}">
