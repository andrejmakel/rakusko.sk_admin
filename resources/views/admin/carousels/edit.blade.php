...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.carousel.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.carousels.update", [$carousel->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lang') ? 'is-invalid' : '' }}" name="lang_id" id="lang_id">
                    @foreach($langs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('lang_id') ? old('lang_id') : $carousel->lang->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('lang'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $carousel->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtitle') ? 'is-invalid' : '' }}" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $carousel->subtitle) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_1') ? 'is-invalid' : '' }}" type="text" name="btn_1" id="btn_1" value="{{ old('btn_1', $carousel->btn_1) }}">
                @if($errors->has('btn_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_2') ? 'is-invalid' : '' }}" type="text" name="btn_2" id="btn_2" value="{{ old('btn_2', $carousel->btn_2) }}">
                @if($errors->has('btn_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_3') ? 'is-invalid' : '' }}" type="text" name="btn_3" id="btn_3" value="{{ old('btn_3', $carousel->btn_3) }}">
                @if($errors->has('btn_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_1_link') ? 'is-invalid' : '' }}" type="text" name="btn_1_link" id="btn_1_link" value="{{ old('btn_1_link', $carousel->btn_1_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_2_link') ? 'is-invalid' : '' }}" type="text" name="btn_2_link" id="btn_2_link" value="{{ old('btn_2_link', $carousel->btn_2_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_3_link') ? 'is-invalid' : '' }}" type="text" name="btn_3_link" id="btn_3_link" value="{{ old('btn_3_link', $carousel->btn_3_link) }}">
