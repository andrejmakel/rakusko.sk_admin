    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-originTransPosts">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.transPost.fields.origin') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-originTransPosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
