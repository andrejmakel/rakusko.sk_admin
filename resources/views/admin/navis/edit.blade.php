...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.navi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.navis.update", [$navi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="description">{{ trans('cruds.navi.fields.description') }}</label>
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $navi->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titel_1') ? 'is-invalid' : '' }}" type="text" name="titel_1" id="titel_1" value="{{ old('titel_1', $navi->titel_1) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_1') ? 'is-invalid' : '' }}" name="text_1" id="text_1">{!! old('text_1', $navi->text_1) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titel_2') ? 'is-invalid' : '' }}" type="text" name="titel_2" id="titel_2" value="{{ old('titel_2', $navi->titel_2) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_2') ? 'is-invalid' : '' }}" name="text_2" id="text_2">{!! old('text_2', $navi->text_2) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titel_3') ? 'is-invalid' : '' }}" type="text" name="titel_3" id="titel_3" value="{{ old('titel_3', $navi->titel_3) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_3') ? 'is-invalid' : '' }}" name="text_3" id="text_3">{!! old('text_3', $navi->text_3) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titel_4') ? 'is-invalid' : '' }}" type="text" name="titel_4" id="titel_4" value="{{ old('titel_4', $navi->titel_4) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_4') ? 'is-invalid' : '' }}" name="text_4" id="text_4">{!! old('text_4', $navi->text_4) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titel_5') ? 'is-invalid' : '' }}" type="text" name="titel_5" id="titel_5" value="{{ old('titel_5', $navi->titel_5) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text_5') ? 'is-invalid' : '' }}" name="text_5" id="text_5">{!! old('text_5', $navi->text_5) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coordinates') ? 'is-invalid' : '' }}" type="text" name="coordinates" id="coordinates" value="{{ old('coordinates', $navi->coordinates) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zoom') ? 'is-invalid' : '' }}" type="number" name="zoom" id="zoom" value="{{ old('zoom', $navi->zoom) }}" step="1">
                @if($errors->has('zoom'))
