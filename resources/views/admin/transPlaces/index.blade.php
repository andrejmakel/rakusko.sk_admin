...
{{-- @can('trans_place_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'TransPlace', 'route' => 'admin.trans-places.parseCsvImport'])
        </div>
    </div>
@endcan --}}
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-TransPlace">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-TransPlace:not(.ajaxTable)').DataTable({ buttons: dtButtons })
