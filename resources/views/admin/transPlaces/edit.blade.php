...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.transPlace.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.trans-places.update", [$transPlace->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
...
{{--             <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('lang') ? 'is-invalid' : '' }}" name="lang_id" id="lang_id" required>
                    @foreach($langs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('lang_id') ? old('lang_id') : $transPlace->lang->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('lang'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('origin') ? 'is-invalid' : '' }}" name="origin_id" id="origin_id" required>
                    @foreach($origins as $id => $entry)
                        <option value="{{ $id }}" {{ (old('origin_id') ? old('origin_id') : $transPlace->origin->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" type="number" name="order" id="order" value="{{ old('order', $transPlace->order) }}" step="1">
                @if($errors->has('order'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $transPlace->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtitle') ? 'is-invalid' : '' }}" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $transPlace->subtitle) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $transPlace->slug) }}">
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('excerp') ? 'is-invalid' : '' }}" name="excerp" id="excerp">{!! old('excerp', $transPlace->excerp) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text') ? 'is-invalid' : '' }}" name="text" id="text">{!! old('text', $transPlace->text) !!}</textarea>
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('opening_note') ? 'is-invalid' : '' }}" name="opening_note" id="opening_note">{!! old('opening_note', $transPlace->opening_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('price_note') ? 'is-invalid' : '' }}" name="price_note" id="price_note">{!! old('price_note', $transPlace->price_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('kontakt') ? 'is-invalid' : '' }}" name="kontakt" id="kontakt">{!! old('kontakt', $transPlace->kontakt) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('parking') ? 'is-invalid' : '' }}" name="parking" id="parking">{!! old('parking', $transPlace->parking) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('info') ? 'is-invalid' : '' }}" name="info" id="info">{!! old('info', $transPlace->info) !!}</textarea>
                @if($errors->has('info'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $transPlace->link) }}">
                @if($errors->has('link'))
